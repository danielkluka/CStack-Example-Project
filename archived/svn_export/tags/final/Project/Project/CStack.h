 ...
 *  \version 2022
 *  $Id: CStack.h 3692 2022-12-30 13:07:18Z xpesek13 $
 */
...
class CStack
	 ...
	 *  \param[in] aStack	Second Stack to be compared with the first Stack
	 ...
	 */
	int CompareDeep(const CStack& aStack) const;
...
public:
	 ...
	 *  \param[in]	aSize	Size of new Stack
	 *	\author Prasek
	 */
	 ...
	 *  \param[in]	aStack	Second Stack, which will be added at the end of first Stack
	 ...
	 *  \param[in]	aStack	Second Stack, which replaces the first Stack in this instance
	 ...
	 *	\param[in]	aStack	CStack on top which will be pushed aBlock element
	 *	\param[in]	aBlock	CBlock element, which will be pushed onto stack
	 ...
	 *	\param[in]	aStack	CStack on which bottom will be added aBlock element
	 *	\param[in]	aBlock	CBlock element, which will be put onto bottom of aStack
	 ...
	 *  \param[in]	aStack	Second Stack, which will be subtracted from the first Stack
	 *	\return New Stack
	 *  \author Prasek
	 */
	CStack operator-(const CStack& aStack) const;
	...
	/** \brief Relational Operator >
	 *  \details Comparison of two stacks using CompareDeep() method.
	 *	param[in]	aStack	CStack to be compared with
	 *  \author Pesek
	 */
	bool operator>(const CStack& aStack) const;
