 ...
 *  \version 2022
 *  $Id: CBlock_TInterval.h 2414 2022-12-11 13:08:00Z xkluka00 $
 */
...
namespace CBlock_TInterval
	...
	/** \brief Maximum method for searching maximum TType boundary of Interval.
	 *  \param[in]	aLeft	Left boundary of Interval
	 *  \param[in]	aRight	Right boundary of Interval
	...
	public:
		 ...
		 *  \details Value attributes are initialized by given values or by default to the \c this value. Method checks if boundaries were set at the right order and switches them in case if not.
		 *  \param[in]	aLeft	Left boundary of Interval
		 *  \param[in]	aRight	Right boundary of Interval
		 *  \author Kluka
		 *  \attention Method demonstrates use of Minimum and Maximum method. For generating exception of bad input is used input operator>>. 
		 */
		TInterval(TType aLeft, TType aRight): iLeft(Minimum(aLeft,aRight)), iRight(Maximum(aLeft,aRight))
			{
			//Values();											//(prints all values of Interval, not activated by default - method is complete and fully functional, activate just for demonstration purposes)
			}
		 ...
		 *  \return Boundaries comparision result using \c enum type TLocation.
		 *  \author Kluka
		 */
	...
	public:
		...
		/** \brief Copy c'tor
		 *  \details Create new instance by copying only \p iValue parameter. Pointer attributes are initialized to the \c this value (CBlockBase definition).
		...
		/** \brief Conversion c'tor
		 *  \details Value is set. Pointer attributes are initialized by given values or by default to the \c this value (CBlockBase definition).
		 ...
		 *  \details Create new instance of CStack. Pointer attributes are initialized by given values or by default to the \c this value (CBlockBase definition).
		 ...
		 *  \details Create new instance from Value in the string. Pointer attributes are initialized by given values or by default to the \c this value (CBlockBase definition).
		 ...
		 *  \details Test value with bad input (\c 5, -4) - constructor fixes bad input automatically using Minimum and Maximum methods - demonstration.
